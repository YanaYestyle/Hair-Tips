    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          e.preventDefault();
          change.src = "video/colorSelection.mp4";
          video.load();
  ...
  intervalPowderBlond = setInterval(() => {
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          e.preventDefault();
          change.src = "video/powderBlond.mp4";
          video.load();
          hairButtonOne.remove();
          hairButtonTwo.remove();
        })
  ...
  intervalToBrown = setInterval(() => {
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          e.preventDefault();
          change.src = "video/blondToBrown.mp4";
          video.load();
          hairButtonOne.remove();
        })
      );
  ...
  intervalToBrunette = setInterval(() => {
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          e.preventDefault();
          change.src = "video/blondToBrunette.mp4";
          video.load();
          hairButtonOne.remove();
        })
      );
  ...
  intervalBrown = setInterval(() => {
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          e.preventDefault();
          change.src = "video/brownHair.mp4";
          video.load();
          hairButtonOne.remove();
          hairButtonTwo.remove();
          hairButtonThree.remove();
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          ...
          hairButtonTwo.remove();
          e.preventDefault();
          change.src = "video/dyeForBlondFromBrown.mp4";
          video.load();
        })
      );
    }
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          ...
          hairButtonTwo.remove();
          e.preventDefault();
          change.src = "video/powderToBlondBrown.mp4";
          video.load();
        })
      );
    }
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          hairButtonOne.remove();
          e.preventDefault();
          change.src = "video/brownToBrunette.mp4";
          video.load();
        })
      );
    }
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          ...
          hairButtonOne.remove();
          e.preventDefault();
          change.src = "video/dyeToBlondBrunette.mp4";
          video.load();
        })
      );
    }
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          ...
          hairButtonTwo.remove();
          e.preventDefault();
          change.src = "video/powderBrunette.mp4";
          video.load();
        })
      );
    }
    ...
    if (hairButtonOne) {
      ...
      resolve(
        hairButtonOne.addEventListener("click", function (e) {
          hairButtonOne.remove();
          e.preventDefault();
          change.src = "video/brunetteToBrown.mp4";
          video.load();
        })
      );
    }
...
function createButton() {
  var divForButton = document.getElementById("forButton");
  var createButton = document.createElement("button");
  var createButtonNew = divForButton.insertAdjacentElement(
    "afterbegin",
    createButton
  );
  createButtonNew.className = "btn btn-primary";
  createButtonNew.id = "button1";
  createButtonNew.innerHTML = "I want to see more";
}
